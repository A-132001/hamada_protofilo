          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start justify-end">
                  <div className="text-right ml-4">
                    ...
                    <p className="text-gray-700">+966 0509 798 965</p>
                  </div>
                ...
                <div className="flex items-start justify-end">
                  <div className="text-right ml-4">
                    ...
                    <p className="text-gray-700">abdelrahmansabry53@gmail.com</p>
                  </div>
                  <div className="bg-amber-100 p-3 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-amber-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex items-start justify-end">
                  <div className="text-right ml-4">
                    ...
                    <p className="text-gray-700">المملكة السعودية، جدة</p>
                  </div>
                  <div className="bg-amber-100 p-3 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-amber-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex items-start justify-end">
                  <div className="text-right ml-4">
                    ...
                    <p className="text-gray-700">يمكنك التواصل في اي وقت</p>
              ...
              <div className="mt-8 pt-6 border-t border-amber-200">
                <h4 className="font-semibold text-amber-800 mb-4 text-right">تواصل معي عبر</h4>
                <div className="flex justify-center space-x-4 space-x-reverse">
                  <a href="https://wa.me/9660509798965" target="_blank" className="bg-green-600 hover:bg-green-700 text-white p-3 rounded-full transition duration-300 transform hover:scale-110">
                  ...
                  <a href="tel:+9660509798965" className="bg-amber-600 hover:bg-amber-700 text-white p-3 rounded-full transition duration-300 transform hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </a>
                  <a href="mailto:abdelrahmansabry53@gmail.com" className="bg-blue-600 hover:bg-blue-700 text-white ml-4 p-3 rounded-full transition duration-300 transform hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </a>
