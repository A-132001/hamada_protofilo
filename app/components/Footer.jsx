export default function Footer() {
    return (
      <footer className="bg-gradient-to-r from-amber-800 to-amber-900 text-white py-10 md:py-12">
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
            ...
            {/* روابط سريعة */}
            <div className="text-right">
              <h3 className="text-xl font-bold mb-6 text-amber-300">روابط سريعة</h3>
              <ul className="space-y-3">
                <li><a href="#hero" className="text-amber-100 hover:text-white transition duration-300">الرئيسية</a></li>
                <li><a href="#about" className="text-amber-100 hover:text-white transition duration-300">من نحن</a></li>
                <li><a href="#services" className="text-amber-100 hover:text-white transition duration-300">خدماتنا</a></li>
                <li><a href="#gallery" className="text-amber-100 hover:text-white transition duration-300">معرض الأعمال</a></li>
                <li><a href="#contact" className="text-amber-100 hover:text-white transition duration-300">اتصل بنا</a></li>
              </ul>
            </div>
            ...
            <div className="text-right">
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-amber-100 hover:text-white transition duration-300">عزل الأسطح والجدران</a></li>
              </ul>
            </div>
